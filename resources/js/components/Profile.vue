      ...
      <div class="col-md-12">
        <div class="card card-widget widget-user mt-3">
          ...
          <div
            ...
            style="background: url('./img/asia-asian-auto-243108.jpg');"
          >
            ...
            <div class="tab-content">
              ...
              <div class="tab-pane active show" id="settings">
                <form class="form-horizontal">
                  ...
                  <div class="form-group">
                    <label for="profilePic" class="col-sm-2 control-label">Foto de Perfil</label>
                  ...
                  <div class="form-group">
                    ...
                    >Password (Dejar vacio para no cambiar)</label>
    ...
    updateInfo() {
      ...
      this.form
        ...
        .then(() => {
          ...
          Toast.fire({
            type: "sucess",
            title: "La Informacion ha sido actualizada"
          });
        })
        .catch(() => {
          this.$Progress.fail();
          Toast.fire({
            type: "error",
            title: "Hubo un error al actualizar informacion"
          });
        });
    },
    updateProfile(e) {
      ...
      if (file["size"] < 5368709) {
        ...
        swal({
          type: "error",
          title: "Error!",
          text: "La Imagen pesa mas de 5MB!"
        });
      }
    }
  },
